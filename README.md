...
AI agents can discover repository types and scopes, format structured input,
validate a message, and create an explicitly authorized commit without driving
the interactive prompt. See the packaged
